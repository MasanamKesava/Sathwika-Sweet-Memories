...
const containerVariants: Variants = {
  hidden: { opacity: 0 },
  visible: { opacity: 1, transition: { staggerChildren: 0.2 } as never },
};

const itemVariants: Variants = {
  hidden: { opacity: 0, y: 30 },
  visible: { opacity: 1, y: 0, transition: { duration: 0.8 } as never },
};
    ...
    <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 pt-24 pb-20 relative">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <p className="font-dancing text-xl md:text-2xl mb-3" style={{ color: "hsl(var(--primary))" }}>
        ...
        >
          "A digital space of flirting, memories, midnight conversations, and a whole lot of 💕"
        </motion.p>

        {/* Rotating flirty quotes */}
        <motion.div
          variants={itemVariants}
          className="mt-6 glass-card rounded-2xl px-6 py-4 max-w-lg mx-auto"
        >
          <motion.p
            key={0}
            ...
            transition={{ duration: 4, repeat: Infinity, repeatDelay: (flirtyLines.length - 1) * 4 }}
          >
            {flirtyLines[0]}
          </motion.p>
        </motion.div>
        ...
        {/* Heart */}
        <motion.div variants={itemVariants} className="my-10 text-6xl animate-heart-beat">
          💖
        </motion.div>

        {/* Love Counter */}
        <motion.div variants={itemVariants}>
          <p className="font-dancing text-2xl mb-6" style={{ color: "hsl(var(--primary))" }}>
        ...
        >
          <p className="font-dancing text-sm">Made with love by Kesava 💕</p>
